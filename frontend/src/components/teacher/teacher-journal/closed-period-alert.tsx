...
export default function ClosedPeriodAlert({ periodName, yearName }: ClosedPeriodAlertProps) {
  ...
  return (
    <div className="max-w-350 mx-auto mb-6 animate-in fade-in slide-in-from-top-2 duration-300">
      <Alert variant="destructive" className="rounded-[24px] bg-linear-to-r from-yellow-50 to-yellow-50/50 border-yellow-200/80 shadow-lg backdrop-blur-sm">
        <div className="flex items-start gap-4">
          <div className="shrink-0 mt-0.5 w-10 h-10 rounded-[14px] bg-yellow-100/60 flex items-center justify-center">
