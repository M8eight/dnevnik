      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mt-1">
        {DAYS_MAP.map((dayInfo) => {
          ...
          return (
            ...
            >
              <p className={`text-[9px] font-extrabold tracking-[0.18em] uppercase mb-2 pb-1.5 border-b ${isToday ? "text-[var(--red)] border-[var(--red)]/15" : "text-black/30 border-black/[0.06]"
                }`}>
