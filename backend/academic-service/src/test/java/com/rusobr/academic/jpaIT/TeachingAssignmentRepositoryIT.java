    ...
    class FindBySubjectIdAndSchoolClassIdAndTeacherId {
        ...
        void success() {
            ...
            Optional<TeachingAssignment> found = teachingAssignmentRepository
                    .findBySubjectIdAndSchoolClassIdAndTeacherIdAndClassGroupId(subject.getId(), schoolClass.getId(), 7L);

            assertThat(found).isPresent();
            assertThat(teachingAssignmentRepository
                    .findBySubjectIdAndSchoolClassIdAndTeacherIdAndClassGroupId(subject.getId(), schoolClass.getId(), 8L)).isNotPresent();
        }
    }
